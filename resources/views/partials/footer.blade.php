 <footer class="bg-info text-white text-center py-4 mt-auto">
    ...
    <div class="row">
      ...
      <div class="col-md-4 mb-4">
        <h5 class="text-uppercase mb-3">Siloam MTC-TC</h5>
        <p class=" text-body text-start text-success fs-6">
          The objective of Siloam Medical, Technical and Commercial Training College is to shape minds and change lives by providing quality education, fostering personal growth, and preparing students for success in both their careers and communities.
        </p>
      </div>
